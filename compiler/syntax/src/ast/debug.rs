...
impl Debug for Decl {
    fn fmt(&self, f: &mut Formatter) -> Result {
        ...
        match &self.kind {
            ...
            | DeclKind::Class { head, body } => {
                writeln!(f, "Class name = {:?}", &**self.name.symbol)?;
            ...
            | DeclKind::InstanceChain { instances: impls } => {
                write!(f, "InstanceChain")?;
...
impl Debug for Instance {
    fn fmt(&self, f: &mut Formatter) -> Result {
        writeln!(f, "Instance name = {:?}", &**self.head.name.symbol)?;
...
impl Debug for InstanceHead {
    fn fmt(&self, f: &mut Formatter) -> Result {
        write!(f, "InstanceHead trait = {:?}", &**self.iface.symbol)?;

...
(function($shade) {
    ...
    $module.$member_Concat_34 = $member_Concat_34;
})(this.$shade || (this.$shade = {}));
// /tmp/.tmpK53kPL
(function($shade) {
    ...
    $module.$member_Print_35 = $member_Print_35;
    function $member_Print_36($r0) {
        return {
            print$: function ($p0) {
                function $l7($l7p0) {
                    return $r0.print$($shade["Js"].push($p0, $l7p0));
                };
                return $l7;
            },
        };
    }
    $module.$member_Print_36 = $member_Print_36;
})(this.$shade || (this.$shade = {}));
// /tmp/.tmpXrsrPM
(function($shade) {
    const $module = $shade["Js.DOM"] || ($shade["Js.DOM"] = {})
    $module.createElement = document.createElement.bind(document);
})(this.$shade || (this.$shade = {}));
// /tmp/.tmpX3r3Si
(function($shade) {
    const $module = $shade["Main"] || ($shade["Main"] = {})
    function main() {
        var $p3 = $shade["Js.DOM"].createElement("a");
        return $shade["Js.Console"].print($shade["Js.Console"].$member_Print_36($shade["Js.Console"].$member_Print_36($shade["Js.Console"].$member_Print_35)))($p3.className)($p3.href);
    }
    $module.main = main;
    $shade.$main = main
})(this.$shade || (this.$shade = {}));

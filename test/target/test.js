...
var Main_main;
Main_main = function() {
    var $p3 = Js_DOM_createElement("a", undefined);
    $p3.innerHTML = "Test";
    function $l17($l17p0) {
        return Js_Console_print($member_Print_36($member_Print_35))("click");
    };
    Node.prototype.addEventListener.call($p3, "click", $l17);
    Node.prototype.appendChild.call(document.body, $p3);
    return Js_Console_print($member_Print_36($member_Print_35))($p3);
};

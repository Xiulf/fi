...
var Main_main;
Main_main = function() {
    var $p6 = new Data_List_Cons(4, new Data_List_Cons(0, new Data_List_Cons(2, new Data_List_Cons(1, new Data_List_Cons(3, new Data_List_Nil())))));
    var $p9 = Data_List_reverse($member_Foldable_39)($p6);
    var $p12 = $member_Index_38.index($p9, 3);
    var $p15 = Data_List_length($p6);
    var $p20 = Js_toArray($member_Foldable_39)(Data_List_sort($member_Ord_32)($p6));
    return Js_Console_print($member_Print_43($member_Print_43($member_Print_43($member_Print_43($member_Print_43($member_Print_42))))))()($p6)($p9)($p12)($p15)($p20);
};
